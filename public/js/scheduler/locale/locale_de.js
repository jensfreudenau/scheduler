...
Scheduler.plugin(function(e) {
    e.locale = {
        date: { month_full: [" Januar", " Februar", " März ", " April", " Mai", " Juni", " Juli", " August", " September ", " Oktober", " November ", " Dezember"], month_short: ["Jan", "Feb", "Mär", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"], day_full: ["Sonntag", "Montag", "Dienstag", " Mittwoch", " Donnerstag", "Freitag", "Samstag"], day_short: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"] },
        labels: {
            ...
            button_edit_occurrence: "Bearbeiten Sie einen einzelnen Termin",
            agenda_tab: "Agenda",
            date: "Datum",
            ...
            hour: "Hour",
            minute: "Minute",
            repeat_radio_day: "Tag",
            repeat_radio_week: "Woche",
            repeat_radio_month: "Monat",
            repeat_radio_year: "Jahr",
            ...
            day_for_recurring: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"]
        }
    }
});
